...
```bash
sudo mkdir -p /var/lib/libvirt /var/log/libvirt /var/cache/libvirt && \
distrobox create --root --init \
    --volume /var/lib/libvirt:/var/lib/libvirt:rw \
    --volume /var/log/libvirt:/var/log/libvirt:rw \
    --volume /var/cache/libvirt:/var/cache/libvirt:rw \
